...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <div class="pt-3 pb-3">
                                    <a href="<?php echo e(url('auth/google')); ?>">Google Login</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\social-login\resources\views/auth/register.blade.php ENDPATH**/ ?>